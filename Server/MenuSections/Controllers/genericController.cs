...
using Contensive.Addons.MenuSections.Models;
using Contensive.Addons.MenuSections.Views;

namespace Contensive.Addons.MenuSections.Controllers
{
    public static class genericController
    {
        ...
        //
        //====================================================================================================
        public static string serializeObject(Contensive.BaseClasses.CPBaseClass cp, object dataObject)
        {
            return (new System.Web.Script.Serialization.JavaScriptSerializer()).Serialize(dataObject);
